...
def get_current_theme_colors():
    ...
    return {
        ...
        "suggestion_bg": theme.get("suggestion_bg", theme.get("primary", "#c0c0c0")),
        "table_border": theme.get("table_border", theme.get("primary", "#c0c0c0")),
        "table_header": get_pt_color_hex(theme.get("table_header", theme.get("primary", "white"))),
        "table_text": get_pt_color_hex(theme.get("table_text", theme.get("primary", "white"))),
        "active_tab": theme.get("active_tab", theme.get("primary", "#c0c0c0")),
        "tab_accent": theme.get("tab_accent", theme.get("primary", "#c0c0c0")),
        "inactive_tab": theme.get("inactive_tab", theme.get("primary", "#c0c0c0")),
        "monitor_graph": theme.get("monitor_graph", theme.get("primary", "#c0c0c0")),
        "monitor_text": get_pt_color_hex(theme.get("monitor_text", theme.get("primary", "white"))),
        "success": theme.get("success", theme.get("primary", "#c0c0c0")),
        "error": theme.get("error", theme.get("secondary", "#FF0000")),
        "warning": theme.get("warning", theme.get("secondary", "#FFFF00")),
        "header_bg": theme.get("header_bg", theme.get("background", "#1c1c1c")),
        "header_text": get_pt_color_hex(theme.get("header_text", theme.get("primary", "white"))),
        "cursor": theme.get("cursor", theme.get("primary", "white")),
        "accent": theme.get("tab_accent", theme.get("primary", "#c0c0c0")),
        "placeholder": theme.get("placeholder", theme.get("primary", "#666666")),
        "dim_text": theme.get("dim_text", theme.get("primary", "#666666")),
        "footer_text": theme.get("footer_text", theme.get("primary", "#444444")),
        "popup_text": theme.get("popup_text", theme.get("primary", "#BBBBBB")),
        "selected_fg": theme.get("selected_fg", theme.get("background", "#000000")),
    }
